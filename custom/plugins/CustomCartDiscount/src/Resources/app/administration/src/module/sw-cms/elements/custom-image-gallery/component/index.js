...
import template from './sw-cms-el-custom-image-gallery.html.twig';
import './sw-cms-el-custom-image-gallery.scss';
 ...
 * @package content
 */
Component.register('sw-cms-el-custom-image-gallery', {
    template,
    ...
    methods: {
        createdComponent() {
            this.initElementConfig('custom-image-gallery');
            this.initElementData('custom-image-gallery');
